#!/bin/sh
#
# Create Programmers-News from calibre recipe by docker container service calibre
...
BOOK_PRE_NAME="programmers-news"
...
################################################################################
# Docker container
IN_RECIPE="./recipes/ProgrammersNews.recipe"
...
###   recipe use the cover-name: cover2.png
docker-compose                      \
